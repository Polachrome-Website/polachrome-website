	...
	<div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
		<div class="modal-dialog">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-dark" onclick="updateDetails()">Save changes</button>
			</div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
		<div class="modal-dialog">
			...
			<div class="modal-body">
				...
				<label class="col-md-3 control-label" for="del_catID"> Category </label> 
				<div id="displayCatList"></div>
				
				<label class="col-md-3 control-label"> Product Images </label> 
				<div class="form-group"><!-- form-group Begin -->
                          
                          <input name="product_img1" type="file" class="form-control" id="del_prodImg1" disabled>
                       
                 </div><!-- form-group Finish -->
                   
                   <div class="form-group"><!-- form-group Begin -->
                          
                          <input name="product_img2" type="file" class="form-control" id="del_prodImg2" disabled>
                       
                   </div><!-- form-group Finish -->
                   
                   <div class="form-group"><!-- form-group Begin -->
                          
                          <input name="product_img3" type="file" class="form-control form-height-custom" id="del_prodImg3" disabled>
	...
	<script>
		...
		function GetDelDetails(updateid){
			...
			$.post("includes/admin_products.inc.php", {delid:updateid}, function(data,status){
				...
				$('#del_catID').val(prodID.catID)
				/*$('#del_prodImg1').val(prodID.prodImg1)
				$('#del_prodImg2').val(prodID.prodImg2)
				$('#del_prodImg3').val(prodID.prodImg3) */
		...
		function GetDelVarDetails(updatevarid){
			...
			$.post("includes/admin_products.inc.php", {delvarid:updatevarid}, function(data,status){
				...
				/* $('#del_prodImg1').val(varID.prodImg1)
				$('#del_prodImg2').val(varID.prodImg2)
				$('#del_prodImg3').val(varID.prodImg3) */
