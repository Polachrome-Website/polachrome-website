        ...
        <div class="panel panel-primary"><!-- panel panel-primary begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-money fa-fw"></i> Orders
                ...
                <div class="table-responsive"><!-- table-responsive begin -->
                    <table class="table table-hover table-striped table-bordered"><!-- table table-hover table-striped table-bordered begin -->
                        ...
                        <?php 
                          ...
                          $get_order = "select * from tbl_orders order by 1 DESC LIMIT 0,5";
            ...
            <div class="panel-body"><!-- panel-body begin -->
                ...
                <div class="mb-md"><!-- mb-md begin -->
                    <div class="widget-content-expanded"><!-- widget-content-expanded begin -->
                        ...
                        <i class="fa fa-envelope"></i> <span> Contact: </span> 0908-123-7390 <br/>
                ...
                <div class="table-responsive"><!-- table-responsive begin -->
                    <table class="table table-hover table-striped table-bordered"><!-- table table-hover table-striped table-bordered begin -->
                        ...
                        <?php 
                          ...
                          $get_users = "select * from user_account order by 1 DESC LIMIT 0,5";
    
                          $run_users = mysqli_query($conn,$get_users);
    
                          while($row_users=mysqli_fetch_array($run_users)){
                              
                              $user_name = $row_users['fullName'];
                              
                              $user_email = $row_users['email'];
                              
                              $account_points = $row_users['accountPoints'];
