...
if(isset($_POST['confirm-order'])){
    ...
    if (!mysqli_stmt_prepare($customer_details_stmt, $insert_customer_details)) {
        ...
        mysqli_stmt_bind_param($customer_details_stmt, "iisssss", $user_id, $invoice_no, $shipping_full_name, $payment_mode, $address, $shipping_email, $shipping_contact);
            ...
            if (!mysqli_stmt_prepare($order_stmt, $insert_order)) {
             ...
             try {
                 ...
                 <p>
                     ...
                     Total Price - <strong>' . $total_fee . '</strong> <br>
