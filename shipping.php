            ...
            <div class="row">
                ...
                <div class="col-md-8 order-md-1 mt-1">
                    ...
                    <div class="action-btn">
                        <button type="button" class="btn btn-return" onclick="location.href='cart.php?item=<?php if(isset($_SESSION['userID'])){echo items();} else{echo guest_items();}?>'">Return to Cart</button>
                        <button type="submit" class="btn btn-proceed" name="submit-shipping">Proceed to Payment</button>
                    </div>
